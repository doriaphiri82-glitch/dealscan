...
def _field_map(meta: Dict[str,Any]) -> Dict[str,str]:
    ...
    pairs={
      ...
      "tax_delinquent_years":[r"delinq.*years",r"years.*delinq"],
      ...
      "has_improvements":[r"^has_?improvements$",r"^improvement_?flag$"],
      "improvement_value":[r"impr.*val",r"building.*val",r"bldg.*val"],
