...
# Source identity for pilot counties is maintained in PILOT_COUNTIES and must not be
# resurrected from stale registry metadata when a configured endpoint changes.
