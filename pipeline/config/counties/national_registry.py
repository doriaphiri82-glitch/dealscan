...
# These are source-verified pilots. They are intentionally NOT marked as ETL-covered
# until a non-empty run persists records through the production pipeline.
