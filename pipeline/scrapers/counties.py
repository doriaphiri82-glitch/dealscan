...
COUNTY_SCRAPERS: Dict[str, Dict[str, Any]] = {
    ...
    "el_paso_tx": {"name":"El Paso County, TX","data_mode":"arcgis","arcgis_layer_url":"https://services2.arcgis.com/fKvlzLJczghwPYHS/ArcGIS/rest/services/ElPasoCADWebService/FeatureServer/0","arcgis_root":"https://services2.arcgis.com/fKvlzLJczghwPYHS/ArcGIS/rest/services/ElPasoCADWebService/FeatureServer/0","fields":{"apn":"prop_id_text","address":["situs_num","situs_street_prefx","situs_street","situs_street_sufix","situs_city","situs_state","situs_zip"],"lot_size_acres":"legal_acreage","market_value":"market","improvement_value":"imprv_val","legal_description":["legal_desc","legal_desc2","legal_desc3"],"owner_name":"file_as_name"},"defaults":{"county_state":"Texas"},"where":"legal_acreage > 0 AND imprv_val = 0","verified":True,"html_search_url":"https://www.epcad.org","status":"EPCAD direct ArcGIS FeatureServer; vacant-land query uses official improvement value"}
}
