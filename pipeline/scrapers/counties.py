...
COUNTY_SCRAPERS: Dict[str, Dict[str, Any]] = {
    "cochise_az": {"name":"Cochise County, AZ","arcgis_root":"https://gis-cochise.opendata.arcgis.com","arcgis_layer_url":"https://services6.arcgis.com/Yxem0VOcqSy8T6TE/ArcGIS/rest/services/Cad_Parcel_TaxInfo/FeatureServer/0","services":[("Parcels","Parcels",["parcel","ownership"]),("Assessor","Assessor",["parcel","ownership"]),("Hosted","Hosted",["parcel","ownership"])],"fields":{"apn":"apn","address":"situs_address","lot_size_acres":"acres","market_value":"fcv","owner_name":"owner_name1","owner_address":"address1","owner_state":"state","land_use":"use_code","legal_description":"legal_text","longitude":"geo_x","latitude":"geo_y"},"defaults":{"county_state":"AZ"},"where":"1=1","verified":True,"html_search_url":"https://parcelinquirytreasurer.cochise.az.gov/Main/ParcelSearch","delinquent_list_url":"https://www.cochise.az.gov/treasurer"},
    "mohave_az": {"name":"Mohave County, AZ","arcgis_root":"https://mcgis.mohave.gov/arcgis/rest/services/PARCELS/MapServer/14","arcgis_layer_url":"https://mcgis.mohave.gov/arcgis/rest/services/PARCELS/MapServer/14","services":[("Parcels","Parcels",["parcel","ownership"]),("Hosted","Hosted",["parcel","ownership"])],"fields":{"apn":"TAXPIN","address":"SITE_ADDRESS","lot_size_acres":"PARCEL_SIZE","lot_size_unit":"UNIT_TYPE","market_value":"FULL_CASH_VALUE","assessed_value":"ASSESSED_FULL_CASH_VALUE","owner_name":"OWNER","owner_address":"MAILING_ADDRESS","owner_state":"STATE","land_use":"USE_CODE","improvement_value":"IMPVALUE","latitude":"LATITUDE","longitude":"LONGITUDE","legal_description":"LEGAL_DESCRIPTION","last_sale_price":"SALEP","last_sale_date":"SALEDT"},"defaults":{"county_state":"AZ"},"where":"1=1","verified":True,"html_search_url":"https://www.mohave.gov/departments/assessor/assessor-search/","delinquent_list_url":"https://www.mohave.gov/departments/information-technology/gis-maps/","source_quality":"official_county_assessor_gis"},
    "el_paso_tx": {"name":"El Paso County, TX","data_mode":"arcgis","arcgis_layer_url":"https://services2.arcgis.com/fKvlzLJczghwPYHS/ArcGIS/rest/services/ElPasoCADWebService/FeatureServer/0","arcgis_root":"https://services2.arcgis.com/fKvlzLJczghwPYHS/ArcGIS/rest/services/ElPasoCADWebService/FeatureServer/0","fields":{"apn":"prop_id_text","address":["situs_num","situs_street_prefx","situs_street","situs_street_sufix","situs_city","situs_state","situs_zip"],"lot_size_acres":"legal_acreage","market_value":"market","improvement_value":"imprv_val","legal_description":["legal_desc","legal_desc2","legal_desc3"],"owner_name":"file_as_name"},"defaults":{"county_state":"TX"},"where":"legal_acreage > 0 AND imprv_val = 0","verified":True,"html_search_url":"https://www.epcad.org","status":"EPCAD direct ArcGIS FeatureServer; vacant-land query uses official improvement value"}
}
