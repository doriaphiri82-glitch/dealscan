...
COUNTY_SCRAPERS: Dict[str, Dict[str, Any]] = {
    ...
    "el_paso_tx": {"name":"El Paso County, TX","data_mode":"arcgis","arcgis_layer_url":"https://services2.arcgis.com/fKvlzLJczghwPYHS/ArcGIS/rest/services/ElPasoCADWebService/FeatureServer/0","arcgis_root":"https://services2.arcgis.com/fKvlzLJczghwPYHS/ArcGIS/rest/services/ElPasoCADWebService/FeatureServer/0","fields":{"apn":"prop_id_text","address":"situs_city","lot_size_acres":"legal_acreage","market_value":"market","legal_description":"legal_desc","owner_name":"file_as_name","owner_state":"situs_state"},"defaults":{"county_state":"Texas"},"where":"1=1","verified":True,"html_search_url":"https://www.epcad.org","status":"EPCAD direct ArcGIS FeatureServer; no Cloudflare-dependent flatfile path"}
}
