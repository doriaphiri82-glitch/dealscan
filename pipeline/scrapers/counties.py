...
COUNTY_SCRAPERS: Dict[str, Dict[str, Any]] = {
    ...
    "mohave_az": {"name":"Mohave County, AZ","arcgis_root":"https://mcgis.mohave.gov/arcgis/rest/services/PARCELS/MapServer/14","arcgis_layer_url":"https://mcgis.mohave.gov/arcgis/rest/services/PARCELS/MapServer/14","services":[("Parcels","Parcels",["parcel","ownership"]),("Hosted","Hosted",["parcel","ownership"])],"fields":{"apn":"TAXPIN","address":"SITE_ADDRESS","lot_size_acres":"PARCEL_SIZE","market_value":"FULL_CASH_VALUE","assessed_value":"ASSESSED_FULL_CASH_VALUE","owner_name":"OWNER","owner_address":"MAILING_ADDRESS","owner_state":"STATE","land_use":"USE_CODE","improvement_value":"IMPVALUE","latitude":"LATITUDE","longitude":"LONGITUDE","legal_description":"LEGAL_DESCRIPTION","last_sale_price":"SALEP","last_sale_date":"SALEDT"},"defaults":{"county_state":"Arizona"},"where":"1=1","verified":True,"html_search_url":"https://www.mohave.gov/departments/assessor/assessor-search/","delinquent_list_url":"https://www.mohave.gov/departments/information-technology/gis-maps/","source_quality":"official_county_assessor_gis"},
